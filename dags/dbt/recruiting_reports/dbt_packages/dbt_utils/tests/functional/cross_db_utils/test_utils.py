...
class TestEscapeSingleQuotesPostgres(
    BaseDbtUtilsBackCompat, BaseEscapeSingleQuotesQuote
):
    pass


@pytest.mark.only_profile("redshift")
class TestEscapeSingleQuotesRedshift(
    BaseDbtUtilsBackCompat, BaseEscapeSingleQuotesQuote
):
    pass
...
class TestEscapeSingleQuotesSnowflake(
    BaseDbtUtilsBackCompat, BaseEscapeSingleQuotesBackslash
):
    pass


@pytest.mark.only_profile("bigquery")
class TestEscapeSingleQuotesBigQuery(
    BaseDbtUtilsBackCompat, BaseEscapeSingleQuotesBackslash
):
    pass
